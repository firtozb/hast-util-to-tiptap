 ...
 * Create a `comment`.
 *
 * @param {HastComment} _node
 * @param {Context} _
 * @returns {TiptapResult}
 */
function comment(_node, _) {
  return ''
 ...
 * @param {import("property-information/lib/util/schema").Schema} schema
 * @param {TiptapTree} result
 * @param {TiptapAttributes} propertiesClone
 */
function fixProperties(properties, schema, result, propertiesClone) {
...
function element(node, ctx) {
  ...
  // Add HTML attributes.
  fixProperties(properties, schema, result, propertiesClone)
